...
export default function Hero() {
  return (
    <section className="relative before:absolute before:inset-0 before:h-80 before:pointer-events-none before:bg-gradient-to-b before:from-zinc-100 before:-z-10">
      <div className="pt-16 pb-6 md:pt-20 md:pb-20">
        {/* Section content */}
          ...
          <div className="max-w-3xl mx-auto">
              <div className="text-center pb-12 md:pb-16">
                <h1 className="font-inter-tight text-4xl md:text-5xl  font-bold bg-clip-text text-transparent bg-gradient-to-r from-zinc-500 via-zinc-900 to-zinc-900 pb-4">
                  Build and launch your start-up idea in <em className="italic relative inline-flex justify-center items-center text-zinc-900"> days
                ...
                <p className="text-lg text-zinc-500 mb-8 ">
                  ...
                  Take advantage of our in-house team of professionals and go from idea to product-ready <span className='font-bold'>in only 30 days</span>.

                </p>
                <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                  <div>
                    <Link className="btn text-zinc-100 bg-zinc-900 hover:bg-zinc-800 w-full shadow" href="https://calendar.app.google/5JqBYPj4hTdFjSQq6">Request A Meeting</Link>
                  </div>
                  <div>
