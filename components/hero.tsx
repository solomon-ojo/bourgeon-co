        ...
        <div className="px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
              <div className="text-center pb-12 md:pb-16">
                <h1 className="font-inter-tight text-4xl md:text-5xl md:pl-2 md:max  font-bold bg-clip-text text-transparent bg-gradient-to-r from-zinc-500 via-zinc-900 to-zinc-900 pb-4">
                  Launch your start-up idea in <em className="italic relative inline-flex justify-center items-center text-zinc-900"> days
                ...
                <p className="text-lg text-zinc-500 mb-8  md:pl-2">
                  Speed is an indespensable asset. Take advantage of our in-house team of professionals and develop your startup <span className='font-bold'>in only 30 days</span>.
                  Find all you need to build your first MVP in one place.
                </p>
